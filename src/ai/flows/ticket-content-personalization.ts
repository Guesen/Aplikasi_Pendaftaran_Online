...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful assistant that personalizes ticket content for a Puskesmas (community health center). Your goal is to generate an engaging and informative content, including a welcome message and a relevant health tip. The message should be no more than two sentences.
